...
import com.wcapp.databinding.ActivityGuidedMeditationBinding
...
class GuidedMeditationActivity : AppCompatActivity() {
    ...
    private fun loadGuidedMeditationSessions() {
        val initialMeditations = listOf(
            GuidedMeditation(1, "Morning Meditation", "Start your day with a calm mind.", "https://youtu.be/jb9B39zrzEo", 1000000),
            GuidedMeditation(2, "Relaxation", "Relax and unwind after a long day.", "https://example.com/relaxation.mp3", 900000),
            GuidedMeditation(3, "Sleep Meditation", "Prepare for a restful sleep.", "https://example.com/sleep.mp3", 1200000)
        )
